 ...
 */
const TM_META = {
  // 2026-09-08 坂本さん指示: 種別フラグを 4値+施主 → 取引先種別12値へ（Salesforce Account.PartnerType__c と同じ値）。
  //   既存コード customer/owner/scrap/subcontractor/sga は据え置き、支払先系7コードを追加。ラベルは SF と共有する日本語。
  //   旧「協力会社」に紐づいていたブロック・種別別必須は支払先系8種別すべてに引き継ぐ。gen_meta_js.py での再生成時はこの改変を維持すること。
  TYPES: ["顧客", "施主", "スクラップ", "外注（請負）", "3D計測", "分析・解析", "産廃処理", "重機・リース", "資材", "燃料", "保安警備", "販管費先"],
  // DBのtype_code ⇔ 画面ラベル
  TYPE_CODES: {customer: '顧客', owner: '施主', scrap: 'スクラップ', subcontractor: '外注（請負）', survey3d: '3D計測', analysis: '分析・解析', waste: '産廃処理', lease: '重機・リース', material: '資材', fuel: '燃料', security: '保安警備', sga: '販管費先'},
  // 支払先系（旧・協力会社）の種別＝協力会社情報ブロックと種別別必須を共有する
  PAYEE_TYPES: ["外注（請負）", "3D計測", "分析・解析", "産廃処理", "重機・リース", "資材", "燃料", "保安警備"],
  TYPE_BLOCKS: {
    "顧客": [
      "与信",
      "請求・入金",
